...
class RetrievalPublicationRecord(Base):
    ...
    embedding_model_name: Mapped[str | None] = mapped_column(String(240))
    embedding_model_version: Mapped[str] = mapped_column(String(120), nullable=False)
    embedding_model_sha256: Mapped[str | None] = mapped_column(String(64))
    ...
    embedding_encoding_profile_sha256: Mapped[str | None] = mapped_column(String(64))
    embedding_protocol_version: Mapped[str | None] = mapped_column(String(120))
